    ...
    public partial class Painel : Page
    {
        ...
        public void entregasdia()
        {
            ...
            try
            {
                ...
                string stringselect = "select count(*) as totalregistros from tbl_entregas where Data_Encomenda = '" + date_formated + "'";
        ...
        private void funcionariosemcampo()
        {
            ...
            try
            {
                string stringselect = "select count(*) as totalregistros from tbl_motoboys";
                OperacaoBanco operacao = new OperacaoBanco();
                System.Data.SqlClient.SqlDataReader dados = operacao.Select(stringselect);
                while (dados.Read())
                {
            ...
            try
            {
                ...
                string stringselect = "select ID_Motoboy from tbl_entregas " +
                        " where Entregue = 1 and Data_Entrega = '" + date_formated + "' group by ID_Motoboy";
                ...
                try { t3 = (contador / t2) * 100; } catch { t3 = 0; }
        ...
        private void entregasefetuadas()
        {
            ...
            {
                lbl_msg.Text = "ERRO:TOTAL DE ENTREGAS NO DIA!";
                throw;
            }
            ...
            try
            {
                ...
                string stringselect = "select count(*) as totalregistros1 from tbl_entregas where " +
                    "Data_Encomenda = '" + date_formated + "' and Entregue=1";
                OperacaoBanco operacao2 = new OperacaoBanco();
                System.Data.SqlClient.SqlDataReader dados2 = operacao2.Select(stringselect);
                while (dados2.Read()) { v2 = Convert.ToInt16(dados2[0]); }
                ConexaoBancoSQL.fecharConexao();

                //calculos de %
                v4 = Convert.ToDecimal(v1);
                try { v3 = (v2 / v4) * 100; } catch {v3 = 0;}
            ...
            {
                lbl_msg.Text = "ERRO: TOTAL DE ENTREGAS EFETUADAS NO DIA!";
                throw;
            }
