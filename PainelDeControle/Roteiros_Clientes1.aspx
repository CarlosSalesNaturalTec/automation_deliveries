...
<body style="margin-left: 2%; margin-right: 2%">
    ...
    <div class="panel panel-success">
        <div class="panel-heading text-center">
            <h4 class="panel-title">Selecionar Motoboy</h4>
        </div>
            ...
            <form class="form-horizontal">
                <fieldset>
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <asp:Literal ID="literal_mtoboy" runat="server"></asp:Literal>
                        </div>
                        <div class="col-md-4">
                            <button id="btselectmotoboy" type="button" class="w3-btn w3-round w3-border w3-light-green w3-hover-green btcontroles" onclick="">
                                Salvar&nbsp;<i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button>
                            <i style="display: none" class="aguarde fa-2x fa fa-cog fa-spin fa-fw w3-text-green w3-right"></i>
                        </div>
                    </div>
                </fieldset>
