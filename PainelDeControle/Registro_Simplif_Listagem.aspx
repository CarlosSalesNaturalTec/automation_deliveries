<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Registro_Simplif_Listagem.aspx.cs" Inherits="Registro_Simplif_Listagem" %>
    ...
    <body style="margin-left: 2%; margin-right: 2%">
        ...
        <div class="w3-row w3-container w3-border w3-round w3-padding-16 w3-light-gray">
            ...
            <div id="Bloco3" class="w3-col s12 m6 l4 w3-padding">
                <div class="panel panel-success">
                    <div class="panel-heading text-center">
                        <h4 class="panel-title w3-small">Controle</h4>
                    </div>
