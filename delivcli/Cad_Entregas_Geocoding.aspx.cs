...
namespace delivcli
{
    public partial class Cad_Entregas_Geocoding : Page
    {
        ...
        protected void bt_novo_salvar_click(object sender, EventArgs e)
        {
            ...
            // string INSERT
            string stringinsert = @"INSERT INTO Tbl_Entregas (ID_Cliente, ID_Motoboy, Nome_Destinatario, Endereco, " +
                    "Data_Encomenda, Telefone, Entregue, Observacoes) VALUES (" + ID_Cli +
                    "," + id_selecionada + ", '" + txt_nome.Text + "', '" + txt_end.Text + "', '" 
        ...
        protected void bt_editar_salvar_click(object sender, EventArgs e)
        {
            ...
            string stringupdate = @"update Tbl_Entregas set ID_Motoboy = " + id_selecionada + ", Nome_Destinatario = '" + txt_edit_nome.Text + "'," +
                " Endereco = '" + txt_edit_end.Text + "', telefone = '" + txt_edit_tel.Text + "', Data_Encomenda = '" + date_formated + "', " +
        ...
        protected void GridView_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txt_edit_tel.Text = GridView2.SelectedRow.Cells[3].Text;
            txt_edit_data.Text = GridView2.SelectedRow.Cells[4].Text;
