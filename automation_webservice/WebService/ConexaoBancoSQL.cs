...
namespace WebService
{
...

    {
        ...
        public ConexaoBancoSQL()
        {
           ...
           stringconnection1 = @"Server=tcp:servermodels.database.windows.net,1433;Initial Catalog=dblog;Persist Security Info=False;User ID={your_username};Password={your_password};MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
            try
            {
